...
namespace QUANLYKHACHSAN_G4_TEAM.DatPhong
{
    public partial class fDatPhong : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (numRow < maxCus)
            {
                if (txtTenKhachHang.Text != "" && txtDiaChi.Text != "" && txtCMND.Text != "")
                {
                    ...
                    dataGridView1.Rows[numRow].Cells["colLoaiKhach"].Value = cmbLoaiKhach.Text;
        ...
        {
            // TODO: This line of code loads data into the 'dATA_QUAN_LY_KHACH_SANDataSet.KHACH_HANG' table. You can move, or remove it, as needed.
